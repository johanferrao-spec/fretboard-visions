...
export default function SongTimeline({
  ...
  }, [dragChord, getRawBeatFromX, onMoveChord, onCommitMove, onResizeChord, zHeld, xHeld, snapGrid, totalBeats, mutateChordType, toDominant7, chords]);
        ...
        <div className="flex items-center gap-1">
          ...
          <select
            ...
            title={
              ...
              genre === 'Jazz' ? 'Pick a groove preset' :
              genre === 'Latin' ? 'Pick a Latin groove (Bossa Nova, more coming)' :
              'Grooves are available for Funk, Rock, Jazz and Latin genres'
            }
          >
            {genre === 'Rock'
